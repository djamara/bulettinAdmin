...
return [
    ...
    */
    ...
    //'project_logo'   => '<img src="public/assets/images/logoCroix.jpg" height="40">',
    'project_logo'   => '<h5 class="text text-white">Croix-Rouge</h5>',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header bg-danger navbar',
    ...
    'developer_name' => 'Cyrille Mikhel DJAMARA',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'http://www.7itmind.com',
